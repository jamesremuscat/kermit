...
public class JiraWatcher extends LogWatcher {
  ...
  private final JiraFeedParser _parser;

  public JiraWatcher(final WatchedPath logPath) {
    this(new JiraFeedParser(), logPath);
  }
