...
public class TestJiraFeedParser extends TestCase {
  ...
  public void testParseMA() throws Exception {
    ...
    assertEquals("09TNFC-1465 in 08JIRA by ma: Matthew Allen commented on TNFC-1465 - TNSQLC subtly fails for unsupported databases: Verified as FIXED in r422114.", entry1.getMessage());
    assertEquals("09TNFC-1465 in 08JIRA by ma: Matthew Allen changed the status to Verified on TNFC-1465 - TNSQLC subtly fails for unsupported databases.", entry2.getMessage());
  }
